...
vertex_name (string, tùy chọn): Tên đỉnh của góc. Ví dụ: "O", "A", "V". (Thường chỉ có 1 chữ cái)

ray1_name (string, tùy chọn): Tên điểm trên tia thứ nhất. Ví dụ: "A", "B". (Thường chỉ có 1 chữ cái, không được trùng với đỉnh của góc)

ray2_name (string, tùy chọn): Tên điểm trên tia thứ hai. Ví dụ: "B", "C". (Thường chỉ có 1 chữ cái, không được trùng với đỉnh của góc)
...
draw_arc (bol): Có vẽ cung tròn biểu diễn dộ góc hay không, nếu không nhắc tới thì mặc định là không
